...
// ShoppingCart DropTarget - collect :: 콜렉트 함수.
...
//
//...리액트 DnD 커넥터와 상태를 컴포넌트의 속성과 연결하는 collect 함수.
//...connectDropTarget 속성 : 이 컴포넌트 DOM 의 어떤 부분이 드래그 가능한 객체를 위한
//...                        대상 영역인지 지정함(예제에서는 간단하게 전체 div를
//...                         드래그 대상으로 만듦).
...
class ShoppingCart extends Component {
  ...
  */
  render() {
    ...
    //...어떻게 하면 snack 의 이름을 ShoppingCart 에서 받아올 수 있을까?
    //...div 를 반환하는 대신 div 를 connectDropTarget 에 래핑함.
